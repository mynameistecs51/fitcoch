    ...
    <div class="bg-white/80 backdrop-blur-md p-8 rounded-2xl border border-slate-200 shadow-sm">
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center gap-3">
                <a href="/profile" class="px-4 py-2 text-sm border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors">
                    Profile
                </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="p-6 rounded-xl border border-slate-200 bg-slate-50">
                ...
                <p class="font-semibold mt-1"><?= escape(implode(', ', $roles)) ?></p>
            </div>
        </div>

        <div class="mt-8 p-6 rounded-xl border border-emerald-200 bg-emerald-50 text-emerald-800">
            <p class="font-semibold">Sprint 2 Complete — Profiles & Role Management</p>
            <p class="text-sm mt-1">Course content and video streaming will arrive in Sprint 3–4.</p>
        </div>
    </div>
</div>
<?php
